...
public class Dataset
{
    ...
    public void normalize()
    {
        ...
        for(int outerLoopCounter=0;outerLoopCounter<=noOfAttributes-1;outerLoopCounter++)
        {
            for(int innerLoopCounter=0;innerLoopCounter<=noOfRecords-1;innerLoopCounter++)
            {
                if(attributeInformation[1][outerLoopCounter].equals("Float")||attributeInformation[1][outerLoopCounter].equals("Integer"))
                {
                    if(dataSet[innerLoopCounter][outerLoopCounter].equals("?"))
                        normalizedDataSet[innerLoopCounter][outerLoopCounter]="?";
                    else
    ...
    ***************************************************************************************/
    ...
    /***************************************************************************************
    * calculate distance method. Absolute distance for numerical attributes and binary
    * distance for categorical attributes
    *
    ***************************************************************************************/
    public double calculateDistance(int recordNo1, int recordNo2)
    {
        double distance=0.0;
        int numberOfAttributeHavingMissingValues=0;
        //System.out.println("Inside calculate distance");
        //System.out.println("recordNo1="+recordNo1);
        //System.out.println("recordNo2="+recordNo2);
        for(int attributeNo=0;attributeNo<=noOfAttributes-2;attributeNo++)
        {
            //System.out.println("Type of Attribute["+attributeNo+"]="+attributeInformation[1][attributeNo]);
            if(attributeInformation[1][attributeNo].equals("Float")||attributeInformation[1][attributeNo].equals("Integer"))
            {
                if(normalizedDataSet[recordNo1][attributeNo].equals("?")||normalizedDataSet[recordNo2][attributeNo].equals("?"))
                    numberOfAttributeHavingMissingValues++;
                else
                {
                    //System.out.println("Double.valueOf(normalizedDataSet[recordNo1][attributeNo])="+Double.valueOf(normalizedDataSet[recordNo1][attributeNo]));
                    distance=distance+Math.abs(Double.valueOf(normalizedDataSet[recordNo1][attributeNo])-Double.valueOf(normalizedDataSet[recordNo2][attributeNo]));
                    //System.out.println("distance="+distance);
                }//end of else
            }//end of if
            else if(attributeInformation[1][attributeNo].equals("Binary")||attributeInformation[1][attributeNo].equals("String"))
            {
                //System.out.println("Double.valueOf(normalizedDataSet[recordNo1][attributeNo])="+Double.valueOf(normalizedDataSet[recordNo1][attributeNo]));
                if(normalizedDataSet[recordNo1][attributeNo].equals("?")||normalizedDataSet[recordNo2][attributeNo].equals("?"))
                    numberOfAttributeHavingMissingValues++;
                else if(dataSet[recordNo1][attributeNo].equals(dataSet[recordNo2][attributeNo]))
                {
                    //System.out.println("distance="+distance);
                }//end of if
                else
        ...
        distance=distance/(noOfAttributes-numberOfAttributeHavingMissingValues-1);
        //System.out.println("distance returned="+distance);//for testing
        return distance;
